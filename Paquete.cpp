...
int main() {
    ...
    cout << "1. Programa 1 (Métodos de Bisección y Secante)\n";
    cout << "2. Programa 2-3 (Operaciones previas: determinante, sustitución, Jacobi, etc.)\n";
    cout << "3. Programa 4 (Cálculo de valores y vectores propios mediante el método de potencias)\n";
    cout << "Opción: ";
    cin >> opcionGeneral;
    ...
    switch (opcionGeneral) {
        case 1: {
            ...
            cout << "Ingrese la función a utilizar: ";
            cin >> funcion;
        ...
        case 2: {
            // Programa 2-3: Operaciones previas del programa
            leerMatriz();
            ...
            if (determinante != 0) {
                ...
                int opcion;
                cout << "Seleccione el método de resolución:\n";
                cout << "1. Sustitución hacia atrás (si la matriz es triangular)\n";
                cout << "2. Método de Jacobi\n";
                cout << "Opción: ";
                cin >> opcion;
                ...
                cout << "El sistema asociado no tiene solución.\n";
            }
            break;
        }
        case 3: {
            // Programa 4: Valores y vectores propios
            leerMatriz();
...
void calcularValoresYVectoresPropios() {
    ...
    printf("\nValor propio máximo: %.6lf\n", lambdaNuevo);
    printf("Vector propio asociado (máximo):\n");
    for (i = 0; i < n; i++) {
        printf("x%d = %.6lf\n", i + 1, vectorNuevo[i]);
    }
    ...
    printf("Vector propio asociado (mínimo):\n");
    for (i = 0; i < n; i++) {
        printf("x%d = %.6lf\n", i + 1, vectorNuevo[i]);
    }
}
